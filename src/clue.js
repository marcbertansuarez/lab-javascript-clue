...
function selectRandom(someArray) {
    ...
    let randomCard = someArray[Math.floor(Math.random() * someArray.length)];
    return randomCard;
}
...
suspectCard.suspect = selectRandom(suspectsArray);
suspectCard.weapon = selectRandom(weaponsArray);
suspectCard.room = selectRandom(roomsArray);
